...
<div class="container">
   <a href="{{ url('addtrainee')}}" class="btn btn-warning">Add Trainee</a> 
       ...
       <div class="box-body with-border">
            <div class="row">
                    ...
                    <div class="col-md-7 col-sm-7 offset-md-2 offset-sm-2 text-center">
                                 ...
                                 <p style="font-size:18px;"><span class="text-green">Status</span> : <span class="text-uppercase">{{$item->status}}</span></p>
